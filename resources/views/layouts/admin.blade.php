...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url("/admin/horarios")}}" class="nav-link">Sistema de reservas de laboratorio</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url("/admin")}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">ULEAM LaB</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url("admin/personals")}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listado de Docente</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item ">
            <a href="#" class="nav-link active" style="background-color: green">
                <i class="nav-icon fas bi bi-building-check"></i>
              <p>
                Laboratorios
                <i class="right fas fa-angle-left"></i>
              </p>
          ...
          <li class="nav-item ">
            <a href="#" class="nav-link active" style="background-color: green">
                <i class="nav-icon fas bi bi-calendar-plus"></i>
              <p>
                Horarios
                <i class="right fas fa-angle-left"></i>
              </p>
          ...
          <li class="nav-item">
    <a href="{{ route('logout') }}" class="nav-link" style="background-color: #a92000;" id=""
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024-2025 <a href="https://youtu.be/qPdPjWkJZF8?si=dFwLMEDy9DrDYgXL">AndreuthLA</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
